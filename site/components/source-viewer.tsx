    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          />
          <div className="relative w-full max-w-2xl bg-white dark:bg-neutral-950 border-l border-neutral-200 dark:border-neutral-800 shadow-xl flex flex-col">
            <div className="sticky top-0 bg-white dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800 z-10">
